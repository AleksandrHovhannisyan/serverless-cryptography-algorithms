...
describe('caesar cipher', () => {
  it('correctly implements unkeyed rot13', () => {
    const rot13 = generateCaesarCipher(13, alphabets.english);
  ...
  it('correctly implements keyed caesar cipher', () => {
    ...
    const rot2 = generateCaesarCipher(2, alphabets.english, 'JULIUS');
  ...
  it('implements shift=s and s-26 symmetrically', () => {
    const rot2 = generateCaesarCipher(2, alphabets.english, 'JULIUS');
    const rot24 = generateCaesarCipher(-24, alphabets.english, 'JULIUS');
