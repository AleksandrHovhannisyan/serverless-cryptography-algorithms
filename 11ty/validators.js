...
const throwIfMissing = (value, queryParamName) =>
  throwIf(!value, `${queryParamName} is required.`);

const throwIfInvalidCipherOperation = (value) => throwIf(!['encipher', 'decipher'].includes(value), `${value} is not a valid operation.`);
